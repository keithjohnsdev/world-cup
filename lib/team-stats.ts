export interface TeamStats {
  ...
  groupAdvanceOdds: number; // % chance to finish top 2 and advance
}

export const TEAM_STATS: Record<string, TeamStats> = {

  // ── Group A ── MEX KOR CZE RSA ────────────────────────────────────────
  MEX: { fifaRank: 13, coach: "Javier Aguirre",      formation: "4-3-3",   lineup: ["G. Ochoa", "J. Sánchez", "C. Montes", "J. Vásquez", "J. Gallardo", "E. Álvarez", "L. Romo", "O. Pineda", "C. Huerta", "S. Giménez", "R. Jiménez"],                          winOdds: 0.8,  groupAdvanceOdds: 65 },
  KOR: { fifaRank: 22, coach: "Hong Myung-Bo",        formation: "4-2-3-1", lineup: ["Jo Hyun-Woo", "K. Moon-Hwan", "K. Min-Jae", "L. Han-Beom", "J. Yu-Min", "H. In-Beom", "B. Jun-Ho", "L. Kang-In", "H. Hee-Chan", "L. Jae-Sung", "Son Heung-Min"],            winOdds: 0.3,  groupAdvanceOdds: 55 },
  ...
  BIH: { fifaRank: 52, coach: "Sergej Barbarez",       formation: "4-3-3",   lineup: ["N. Vasilj", "A. Dedic", "D. Hadzikadunic", "N. Katic", "S. Kolasinac", "A. Hadziahmetovic", "B. Tahirovic", "I. Sunjic", "E. Demirovic", "E. Dzeko", "H. Tabakovic"],        winOdds: 0.05, groupAdvanceOdds: 42 },
  ...
  BRA: { fifaRank: 5,  coach: "Carlo Ancelotti",       formation: "4-3-3",   lineup: ["Alisson", "Danilo", "Marquinhos", "G. Magalhães", "A. Sandro", "Casemiro", "Bruno Guimarães", "L. Paquetá", "Neymar", "Vinícius Jr", "Endrick"],                             winOdds: 11,   groupAdvanceOdds: 88 },
  ...
  ECU: { fifaRank: 30, coach: "Sebastián Beccacece",   formation: "4-3-3",   lineup: ["H. Galíndez", "Á. Preciado", "W. Pacho", "F. Torres", "P. Estupiñán", "M. Caicedo", "K. Páez", "J. Alcivar", "G. Plata", "E. Valencia", "A. Valencia"],                     winOdds: 0.2,  groupAdvanceOdds: 52 },
  ...
  NED: { fifaRank: 8,  coach: "Ronald Koeman",         formation: "4-3-3",   lineup: ["B. Verbruggen", "D. Dumfries", "V. Van Dijk", "N. Aké", "J. Timber", "F. De Jong", "T. Reijnders", "T. Koopmeiners", "C. Gakpo", "B. Brobbey", "D. Malen"],               winOdds: 4,    groupAdvanceOdds: 75 },
  ...
  NZL: { fifaRank: 95, coach: "Darren Bazeley",        formation: "4-4-2",   lineup: ["M. Crocombe", "T. Smith", "M. Boxall", "N. Pijnaker", "L. Cacace", "J. Bell", "M. Stamenic", "S. Singh", "A. Rufer", "C. Wood", "B. Waine"],                               winOdds: 0.02, groupAdvanceOdds: 18 },
  ...
  URU: { fifaRank: 15, coach: "Marcelo Bielsa",        formation: "4-4-2",   lineup: ["S. Rochet", "G. Varela", "J. Giménez", "R. Araújo", "M. Olivera", "F. Valverde", "R. Bentancur", "M. Ugarte", "G. De Arrascaeta", "D. Núñez", "F. Pellistri"],           winOdds: 1.5,  groupAdvanceOdds: 65 },
  KSA: { fifaRank: 57, coach: "Georgios Donis",        formation: "4-3-3",   lineup: ["M. Al Owais", "S. Abdulhamid", "H. Tambakti", "J. Thikri", "A. Lajami", "M. Kanno", "N. Al Dawsari", "S. Al Dawsari", "F. Al Buraikan", "S. Al Shehri", "A. Al Hamdan"], winOdds: 0.08, groupAdvanceOdds: 37 },
  ...
  NOR: { fifaRank: 24, coach: "Ståle Solbakken",       formation: "4-3-3",   lineup: ["Ø. Nyland", "M. Pedersen", "L. Østigård", "K. Ajer", "J. Ryerson", "S. Berge", "M. Ødegaard", "F. Aursnes", "A. Sørloth", "E. Haaland", "A. Nusa"],                      winOdds: 0.4,  groupAdvanceOdds: 55 },
  ...
  IRQ: { fifaRank: 62, coach: "Graham Arnold",         formation: "4-3-3",   lineup: ["J. Hassan", "H. Ali", "M. Saadoon", "A. Hashem", "Z. Tahseen", "Z. Iqbal", "K. Yakob", "A. Sher", "A. Jasim", "A. Al-Hamadi", "A. Hussein"],                              winOdds: 0.05, groupAdvanceOdds: 8 },

  // ── Group J ── ARG AUT ALG JOR ────────────────────────────────────────
  ARG: { fifaRank: 1,  coach: "Lionel Scaloni",        formation: "4-3-3",   lineup: ["E. Martínez", "G. Montiel", "C. Romero", "L. Martínez", "N. Tagliafico", "R. De Paul", "E. Fernández", "A. Mac Allister", "L. Messi", "Lautaro", "J. Álvarez"],           winOdds: 18,   groupAdvanceOdds: 92 },
  AUT: { fifaRank: 25, coach: "Ralf Rangnick",         formation: "4-2-3-1", lineup: ["P. Pentz", "S. Posch", "D. Alaba", "P. Lienhart", "P. Mwene", "N. Seiwald", "K. Laimer", "M. Sabitzer", "C. Baumgartner", "P. Wimmer", "M. Arnautovic"],                  winOdds: 0.3,  groupAdvanceOdds: 52 },
  ALG: { fifaRank: 30, coach: "Vladimir Petkovic",     formation: "4-3-3",   lineup: ["O. Benbot", "A. Mandi", "R. Bensebaini", "R. Ait Nouri", "J. Hadjam", "I. Maza", "R. Zerrouki", "F. Chaibi", "R. Mahrez", "A. Gouiri", "M. Amoura"],                      winOdds: 0.2,  groupAdvanceOdds: 48 },
  JOR: { fifaRank: 73, coach: "Jamal Sellami",         formation: "4-4-2",   lineup: ["A. Al-Fakhouri", "I. Haddad", "S. Al-Rosan", "H. Abu Dahab", "A. Nasib", "N. Al-Rawabdeh", "M. Al-Dawoud", "A. Jamous", "M. Abu Taha", "M. Al-Tamari", "A. Azaizeh"],    winOdds: 0.03, groupAdvanceOdds: 8 },

  // ── Group K ── POR COL COD UZB ────────────────────────────────────────
  POR: { fifaRank: 7,  coach: "Roberto Martínez",      formation: "4-3-3",   lineup: ["D. Costa", "J. Cancelo", "R. Dias", "G. Inácio", "N. Mendes", "B. Fernandes", "B. Silva", "Vitinha", "C. Ronaldo", "R. Leão", "P. Neto"],                                 winOdds: 6,    groupAdvanceOdds: 80 },
  COL: { fifaRank: 19, coach: "Néstor Lorenzo",        formation: "4-2-3-1", lineup: ["D. Ospina", "D. Muñoz", "D. Sánchez", "J. Lucumí", "J. Mojica", "R. Ríos", "K. Castaño", "J. Carrascal", "J. Rodríguez", "J. Arias", "L. Díaz"],                         winOdds: 1.5,  groupAdvanceOdds: 68 },
  COD: { fifaRank: 57, coach: "Sébastien Desabre",     formation: "4-3-3",   lineup: ["M. Epolo", "A. Wan-Bissaka", "C. Mbemba", "A. Masuaku", "A. Tuanzebe", "N. Sadiki", "G. Kakuta", "N. Mukau", "Y. Wissa", "C. Bakambu", "S. Banza"],                       winOdds: 0.1,  groupAdvanceOdds: 28 },
  UZB: { fifaRank: 59, coach: "Fabio Cannavaro",       formation: "4-3-3",   lineup: ["U. Yusupov", "A. Khusanov", "R. Ashurmatov", "J. Urozov", "F. Sayfiev", "J. Masharipov", "A. Fayzullaev", "O. Urunov", "E. Shomurodov", "A. Amonov", "D. Khamdamov"],    winOdds: 0.05, groupAdvanceOdds: 24 },

  // ── Group L ── ENG CRO GHA PAN ────────────────────────────────────────
  ENG: { fifaRank: 4,  coach: "Thomas Tuchel",         formation: "4-3-3",   lineup: ["J. Pickford", "R. James", "J. Stones", "M. Guéhi", "T. Livramento", "D. Rice", "J. Bellingham", "K. Mainoo", "B. Saka", "H. Kane", "A. Gordon"],                          winOdds: 8,    groupAdvanceOdds: 76 },
  CRO: { fifaRank: 10, coach: "Zlatko Dalić",          formation: "4-3-3",   lineup: ["D. Livaković", "J. Stanišić", "J. Gvardiol", "D. Caleta-Car", "J. Sutalo", "L. Modrić", "M. Kovačić", "M. Pašalić", "I. Perišić", "A. Kramarić", "N. Vlašić"],           winOdds: 1.0,  groupAdvanceOdds: 65 },
  GHA: { fifaRank: 60, coach: "Carlos Queiroz",        formation: "4-2-3-1", lineup: ["L. Ati-Zigi", "A. Seidu", "A. Mumin", "G. Mensah", "J. Adjetey", "T. Partey", "E. Owusu", "K. Sulemana", "A. Semenyo", "A. Fatawu", "I. Williams"],                       winOdds: 0.2,  groupAdvanceOdds: 42 },
  PAN: { fifaRank: 63, coach: "Thomas Christiansen",   formation: "4-4-2",   lineup: ["L. Mejía", "A. Murillo", "F. Escobar", "A. Andrade", "J. Córdoba", "A. Godoy", "A. Carrasquilla", "Y. Bárcenas", "A. Quintero", "I. Díaz", "J. Fajardo"],                winOdds: 0.02, groupAdvanceOdds: 17 },
};
