              ...
              >
                {t === "news" ? (
                  <span className="relative inline-block">
                    📰 News
                    <span className="absolute -top-2 -right-[26px] rounded-full border border-green-400 bg-green-400/10 px-1 py-px text-[7px] font-black uppercase tracking-tight text-green-400 drop-shadow-[0_0_4px_rgba(74,222,128,0.8)] animate-pulse">
                      New!
                    </span>
                  </span>
                ) : t === "groups" ? (
