      ...
      <div style={{ zoom }}>
        ...
        <Section title="Kid Powers">
          ...
          <div className="space-y-3">
            ...
            <PowerRow name="🤝 With Our Powers Combined" description="At any point during the bracket stage, if two kids' scores added together is less than the current leader, you can merge into one team and play the rest of the tournament together as a single entry." />
          </div>
        </Section>
