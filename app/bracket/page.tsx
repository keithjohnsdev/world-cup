    ...
    <div className="min-h-screen bg-green-950">
      ...
      <div className="max-w-2xl mx-auto px-4 pt-6 pb-2">
        <div className="flex justify-center">
          <div className="flex bg-black/30 rounded-xl p-1 gap-0.5">
            {(["rules", "groups", "bracket"] as const).map((t) => (
              <button
                key={t}
                onClick={() => setTab(t)}
                className={`px-4 py-2 rounded-lg text-xs font-black uppercase tracking-[0.15em] whitespace-nowrap transition-all ${
                  tab === t
                    ? "bg-yellow-300 text-green-950 shadow"
