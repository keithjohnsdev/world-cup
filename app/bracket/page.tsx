      ...
      <div style={{ zoom }}>
        ...
        <Section title="Kid Powers">
          ...
          <div className="space-y-3">
            ...
            <PowerRow name="🤝 With Our Powers Combined" description="At any point during the bracket stage, if two kids' scores added together is less than the current leader, you can add your scores together and play the rest of the game as a team." />
          </div>
        </Section>
