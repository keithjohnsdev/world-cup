...
Once the group stage is complete and the real bracket is set, everyone picks the knockout rounds fresh — Round of 32 all the way through the Final. You're picking real matchups between teams you just watched for three weeks.
...
Everyone wins something. Awards are announced after the Final.
...
| Award | Description |
|-------|-------------|
| **Wooden Spoon** | Dead last — awarded with full ceremony and a literal wooden spoon |
| **Heartbreak Hotel** | Most picks that lost specifically in penalty shootouts — the universe has a grudge |
| **The Human Coin Flip** | Accuracy closest to exactly 50% — perfectly, uselessly neutral |
